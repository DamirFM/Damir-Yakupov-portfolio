...
export default function Project({
    ...
    return (
        ...
        >
            <section
                className=' bg-gray-100 max-w-[42rem] rounded-lg border border-black/5 overflow-hidden sm:pr-8 relative sm:h-[20rem] mb-3 sm:mb-8 last:mb-0  hover:bg-gray-200 transition group-even:pl-8'>
