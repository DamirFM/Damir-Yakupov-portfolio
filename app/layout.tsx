  ...
  return (
    <html lang="en">
      ...
      <body className={`${inter.className} bg-gray-50 text-gray-950 relative`}>
        ...
        <div className="bg-[#e7fbd7] absolute top-[-6rem] -z-10 left-[-35rem] h-[31.25rem] w-[50rem] rounded-full blur-[10rem] sm:w-[68.75rem] md:left-[-33rem] lg:left-[28rem] xl:left-[15rem] 2xl:left-[-5rem]"></div>
        {/* page.tsx */}
        {children}
        </body>
    </html>
